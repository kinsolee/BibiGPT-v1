...
const catalogCases = [
  ...
  [{ id: 'a/image-only-output', capabilities: { output_modalities: ['image'] } }, false],
  [{ id: 'a/audio-only-output', capabilities: { output_modalities: ['audio'] } }, false],
  [{ id: 'a/audio-in-text-out', capabilities: { input_modalities: ['audio'], output_modalities: ['text'] } }, false],
